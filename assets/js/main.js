(function () {
  ...
  window.onscroll = function () {
    ...
    if (ud_header.classList.contains("sticky")) {
      logo.src = "assets/images/ASCENTwordmarkblack.png";
    } else {
      logo.src = "assets/images/ASCENTwordmarkwhite.png";
    }
...
function calcTime(dates) {
    ...
    document.querySelector('.clock-header').innerHTML = 'EVENT WILL START IN';

		if(now >= date){
			clearInterval(startTimer);
			document.querySelector('.clock-day').innerHTML = 'J';
			document.querySelector('.clock-hours').innerHTML = 'O';
			document.querySelector('.clock-minutes').innerHTML = 'I';
			document.querySelector('.clock-seconds').innerHTML = 'N';
      document.querySelector('.clock-header').innerHTML = 'EVENT HAS STARTED';
		}
	}
